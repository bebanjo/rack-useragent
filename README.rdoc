...
You're in luck. Just add this to your <tt>environment.rb</tt> file
...
No problem, just add <tt>upgrade.es.html</tt> and <tt>upgrade.fr.html</tt> to <tt>/public</tt> (<tt>rack.locale</tt> env variable needs to be set for this to work. <tt>Rack::Locale</tt> in rack-contrib[http://github.com/rack/rack-contrib] can do that)
